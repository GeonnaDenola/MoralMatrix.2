...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $null = NULL; // placeholder for LONGBLOB
    $stmtIns->bind_param("sssssb",
        $student_id, $offense_category, $offense_type, $offense_details, $description, $null
    );
    if ($photo !== null) {
...
$sidSafe = htmlspecialchars($student['student_id'] ?? '', ENT_QUOTES);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <?php if ($student): ?>
    ...
    <div id="lightForm" class="form-container">
      <form method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="student_id" value="<?= $sidSafe ?>">
